...
func (o *IdentityPhoneNumber) GetSourceId() string {
...
// and a boolean to check if the value has been set.
func (o *IdentityPhoneNumber) GetSourceIdOk() (*string, bool) {
	if o == nil || o.SourceId == nil {
		return nil, false
	}
...
func (o *IdentityPhoneNumber) HasSourceId() bool {
	if o != nil && o.SourceId != nil {
		return true
	}
...
func (o *IdentityPhoneNumber) SetSourceId(v string) {
	o.SourceId = &v
}
