...
func (o *IdentityDateOfBirth) GetSourceId() string {
...
// and a boolean to check if the value has been set.
func (o *IdentityDateOfBirth) GetSourceIdOk() (*string, bool) {
	if o == nil || o.SourceId == nil {
		return nil, false
	}
...
func (o *IdentityDateOfBirth) HasSourceId() bool {
	if o != nil && o.SourceId != nil {
		return true
	}
...
func (o *IdentityDateOfBirth) SetSourceId(v string) {
	o.SourceId = &v
}
