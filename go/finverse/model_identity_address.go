...
func (o *IdentityAddress) GetSourceId() string {
...
// and a boolean to check if the value has been set.
func (o *IdentityAddress) GetSourceIdOk() (*string, bool) {
	if o == nil || o.SourceId == nil {
		return nil, false
	}
...
func (o *IdentityAddress) HasSourceId() bool {
	if o != nil && o.SourceId != nil {
		return true
	}
...
func (o *IdentityAddress) SetSourceId(v string) {
	o.SourceId = &v
}
