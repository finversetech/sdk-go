...
type CustomerApi interface {
	...
	*/
	...
	CreatePaymentExecute(r CustomerApiApiCreatePaymentRequest) (*CreatePaymentResponse, *http.Response, error)
	...
	*/
	...
	GetPaymentExecute(r CustomerApiApiGetPaymentRequest) (*GetPaymentResponse, *http.Response, error)
...
func (r CustomerApiApiCreatePaymentRequest) Execute() (*CreatePaymentResponse, *http.Response, error) {
...
// Execute executes the request
//  @return CreatePaymentResponse
func (a *CustomerApiService) CreatePaymentExecute(r CustomerApiApiCreatePaymentRequest) (*CreatePaymentResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r CustomerApiApiGetMandateAuthRequest) InstitutionId(institutionId string) CustomerApiApiGetMandateAuthRequest {
...
func (a *CustomerApiService) GetMandateAuthExecute(r CustomerApiApiGetMandateAuthRequest) (*GetMandateAuthResponse, *http.Response, error) {
	...
	if r.institutionId == nil {
		return localVarReturnValue, nil, reportError("institutionId is required and must be specified")
	}
...
func (r CustomerApiApiGetPaymentRequest) Execute() (*GetPaymentResponse, *http.Response, error) {
...
// Execute executes the request
//  @return GetPaymentResponse
func (a *CustomerApiService) GetPaymentExecute(r CustomerApiApiGetPaymentRequest) (*GetPaymentResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
