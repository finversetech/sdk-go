...
type DefaultAPI interface {
	...
	*/
	...
	/*
		SelectPaymentMethodPaymentLink Method for SelectPaymentMethodPaymentLink

		Select a payment method for payment link

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return DefaultAPISelectPaymentMethodPaymentLinkRequest
	*/
	SelectPaymentMethodPaymentLink(ctx context.Context) DefaultAPISelectPaymentMethodPaymentLinkRequest

	// SelectPaymentMethodPaymentLinkExecute executes the request
	//  @return SelectPaymentMethodResponse
	SelectPaymentMethodPaymentLinkExecute(r DefaultAPISelectPaymentMethodPaymentLinkRequest) (*SelectPaymentMethodResponse, *http.Response, error)
...
type DefaultAPISelectPaymentMethodPaymentLinkRequest struct {
	ctx                        context.Context
	ApiService                 DefaultAPI
	selectPaymentMethodRequest *SelectPaymentMethodRequest
}

// request body for selecting a payment method
func (r DefaultAPISelectPaymentMethodPaymentLinkRequest) SelectPaymentMethodRequest(selectPaymentMethodRequest SelectPaymentMethodRequest) DefaultAPISelectPaymentMethodPaymentLinkRequest {
	r.selectPaymentMethodRequest = &selectPaymentMethodRequest
	return r
}

func (r DefaultAPISelectPaymentMethodPaymentLinkRequest) Execute() (*SelectPaymentMethodResponse, *http.Response, error) {
	return r.ApiService.SelectPaymentMethodPaymentLinkExecute(r)
}
...
Select a payment method for payment link
 ...
 @return DefaultAPISelectPaymentMethodPaymentLinkRequest
*/
func (a *DefaultAPIService) SelectPaymentMethodPaymentLink(ctx context.Context) DefaultAPISelectPaymentMethodPaymentLinkRequest {
	return DefaultAPISelectPaymentMethodPaymentLinkRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return SelectPaymentMethodResponse
func (a *DefaultAPIService) SelectPaymentMethodPaymentLinkExecute(r DefaultAPISelectPaymentMethodPaymentLinkRequest) (*SelectPaymentMethodResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SelectPaymentMethodResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.SelectPaymentMethodPaymentLink")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/payment_links/fvlink/select_payment_method"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.selectPaymentMethodRequest == nil {
		return localVarReturnValue, nil, reportError("selectPaymentMethodRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.selectPaymentMethodRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
