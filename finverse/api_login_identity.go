...
type LoginIdentityApi interface {
	...
	*/
	...
	// GetStatementLinkExecute executes the request
	...
	*/
	...
	/*
		ListPaymentInstructions Method for ListPaymentInstructions

		Get list of payment instructions to be used when linking to perfom debit authorization

		 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		 @return LoginIdentityApiApiListPaymentInstructionsRequest
	*/
	ListPaymentInstructions(ctx context.Context) LoginIdentityApiApiListPaymentInstructionsRequest

	// ListPaymentInstructionsExecute executes the request
	//  @return ListPaymentInstructionsResponse
	ListPaymentInstructionsExecute(r LoginIdentityApiApiListPaymentInstructionsRequest) (*ListPaymentInstructionsResponse, *http.Response, error)
...
func (a *LoginIdentityApiService) GetStatementLinkExecute(r LoginIdentityApiApiGetStatementLinkRequest) (*GetStatementLinkResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/statement_links/{statementId}"
	localVarPath = strings.Replace(localVarPath, "{"+"statementId"+"}", url.PathEscape(parameterToString(r.statementId, "")), -1)
...
type LoginIdentityApiApiListPaymentInstructionsRequest struct {
	ctx        context.Context
	ApiService LoginIdentityApi
}

func (r LoginIdentityApiApiListPaymentInstructionsRequest) Execute() (*ListPaymentInstructionsResponse, *http.Response, error) {
	return r.ApiService.ListPaymentInstructionsExecute(r)
}
...
Get list of payment instructions to be used when linking to perfom debit authorization
 ...
 @return LoginIdentityApiApiListPaymentInstructionsRequest
*/
func (a *LoginIdentityApiService) ListPaymentInstructions(ctx context.Context) LoginIdentityApiApiListPaymentInstructionsRequest {
	return LoginIdentityApiApiListPaymentInstructionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return ListPaymentInstructionsResponse
func (a *LoginIdentityApiService) ListPaymentInstructionsExecute(r LoginIdentityApiApiListPaymentInstructionsRequest) (*ListPaymentInstructionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListPaymentInstructionsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LoginIdentityApiService.ListPaymentInstructions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
