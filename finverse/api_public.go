...
func (r PublicApiApiGetCredSubmitJwksRequest) Execute() (*http.Response, error) {
...
get jwks
 ...
 @return PublicApiApiGetCredSubmitJwksRequest
*/
func (a *PublicApiService) GetCredSubmitJwks(ctx context.Context) PublicApiApiGetCredSubmitJwksRequest {
	return PublicApiApiGetCredSubmitJwksRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (r PublicApiApiGetPaymentsJwksRequest) Execute() (*GetJWKSResponse, *http.Response, error) {
...
get payment jwks
 ...
 @return PublicApiApiGetPaymentsJwksRequest
*/
func (a *PublicApiService) GetPaymentsJwks(ctx context.Context) PublicApiApiGetPaymentsJwksRequest {
	return PublicApiApiGetPaymentsJwksRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return GetJWKSResponse
func (a *PublicApiService) GetPaymentsJwksExecute(r PublicApiApiGetPaymentsJwksRequest) (*GetJWKSResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
