...
func (o *PaymentSetupOptions) GetFuturePayments() FuturePaymentsMode {
...
func (o *PaymentSetupOptions) GetFuturePaymentsOk() (*FuturePaymentsMode, bool) {
	if o == nil || IsNil(o.FuturePayments) {
		return nil, false
	}
...
func (o *PaymentSetupOptions) SetFuturePayments(v FuturePaymentsMode) {
	o.FuturePayments = &v
}
