...
// checks if the MandateRecipientRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MandateRecipientRequest{}
...
func (o *MandateRecipientRequest) UnmarshalJSON(data []byte) (err error) {
