...
func (o *GetMandateResponse) GetSenderDetails() []SenderDetail {
...
// and a boolean to check if the value has been set.
func (o *GetMandateResponse) GetSenderDetailsOk() ([]SenderDetail, bool) {
	if o == nil || o.SenderDetails == nil {
		return nil, false
	}
...
func (o *GetMandateResponse) HasSenderDetails() bool {
	if o != nil && o.SenderDetails != nil {
		return true
	}
...
func (o *GetMandateResponse) SetSenderDetails(v []SenderDetail) {
	o.SenderDetails = v
}
