...
type _ErrBodyModelV2 ErrBodyModelV2
...
func (o *ErrBodyModelV2) UnmarshalJSON(data []byte) (err error) {
	varErrBodyModelV2 := _ErrBodyModelV2{}

	err = json.Unmarshal(data, &varErrBodyModelV2)

	if err != nil {
		return err
	}

	*o = ErrBodyModelV2(varErrBodyModelV2)
